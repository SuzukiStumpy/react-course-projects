...
function Button({ children, to, type, onClick, disabled = false }) {
    const base =
    ...
    const styles = {
        ...
        secondary:
            'inline-block rounded-full text-xs border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:text-stone-800 hover:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 focus:text-stone-800 disabled:cursor-not-allowed px-2 py-2.5 md:px-6 md:py-3.5',
